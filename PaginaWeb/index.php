                    ...
                    <div class="col-md-4 col-md-offset-4" >
                        <div class="panel panel-default" style="background-color: #228B22;">
                            ...
                            <div class="panel-body">
                                <form accept-charset="UTF-8" role="form" class="form-signin" action="php/LogarUsuario.php" method="POST">
                                    <fieldset>
                                        <label class="panel-login">
                                            <div class="login_result"></div>
                                        </label>
                                        <input class="form-control" placeholder="Cpf" name="cpf" required  type="text">
                                        <input class="form-control" placeholder="Senha" name="senha" required type="password">
                                        <?php 
